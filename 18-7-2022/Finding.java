// write a java program  to print second biggest and smallest element of an array
import java.util.*;
class Finding
{
public static void main(String args[])
{
 ...
 System.out.println("\nPrinting an second biggest elements of an array\n"+arr[len-2]);
 
 System.out.println("-----------------******--------------------\n");
 System.out.println("Printing an smallest elements of an array\n"+arr[0]);
}
}