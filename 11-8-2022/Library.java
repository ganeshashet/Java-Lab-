/*java program to acheive aggregation, Create class named Book which is having Author class has entity reference
Class book => bookId,bookName,bookAuthor(Entity reference)
Author => authorName, authorCountry, authorAge*/
